...
static int vg_ocl_kernel_start(vg_ocl_context_t *vocp, int slot, long unsigned int ncol, long unsigned int nrow,
                               int invsize)
{
    cl_int val, ret;
    cl_event ev;
                   ...
                   int invsize)
{
     ...
     *
     * The ratio on most GPUs with the lux-vanity-gpu implementations
